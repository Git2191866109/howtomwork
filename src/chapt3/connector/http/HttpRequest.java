...
import chapt3.connector.RequestStream;
...
public class HttpRequest implements HttpServletRequest {
    ...
    protected void parseParameters() {
        ...
        // Parse any parameters specified in the input stream  HTTP 请求内容是否包含参数
        /*方法尝试查看 HTTP 请求内容是否包含参数。这种情况发生在当用户使用 POST 方法
...
//        方法锁定 ParameterMap，设置 parsed 为 true，并把 results 赋予parameters
